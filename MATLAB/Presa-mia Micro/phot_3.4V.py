...
data_arr = pd.read_csv('phot_3.4V.csv' , delimiter=',', header=None)
hist_arr = pd.read_csv('hist_phot_3.4V.csv' , delimiter=',', header=None)
...
plt.savefig('phot_3.4V.pdf', format='pdf', bbox_inches='tight')
